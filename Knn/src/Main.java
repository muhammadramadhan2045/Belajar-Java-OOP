...
public class Main {
     ...
     */
    private static final String TRAINING_DATA_FILES = "E:\\Learn Java\\Knn\\src\\DataTraining.txt";

    /**
     * TESTING_DATA_FILES merupakan lokasi data testing
     */
    private static final String TESTING_DATA_FILES = "E:\\Learn Java\\Knn\\src\\DataTesting.txt";
    ...
    private static void searchHypotesis() {
        ...
        for (Point testingPoint : testingPoints) {
            ...
            distanceList.clear();//mengclear nilai distanceList disetiap selesai datatesting
            nearestPoints.clear();
